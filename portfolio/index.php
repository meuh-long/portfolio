...
<link rel="manifest" href="/images/favicon/site.webmanifest" />
    ...
    <script type="application/ld+json">
    {
        ...
        "sameAs": [
            "https://www.instagram.com/adenomatose.polyendocrinienne/",
...
<body>
        ...
        <div class="work-grid apparition-work">
            ...
            <div class="work-item work-item-large" data-category="photo" tabindex="0">
                ...
                <dialog class="work-item-detail" aria-labelledby="dialog-title-photo" aria-modal="true" role="alertdialog">
                    <button class="close-btn" aria-label="Fermer la fenêtre modale">✕</button>
                    <a href="https://www.instagram.com/adenomatose.polyendocrinienne/" target="_blank" rel="noopener noreferrer" class="instagram-btn" aria-label="Voir plus de photos sur Instagram">
    ...
    <section class="contact" id="contact">
        ...
        <div class="contact-container apparition-contact">
            <a href="https://www.instagram.com/adenomatose.polyendocrinienne/" target="_blank" rel="noopener noreferrer" class="social-btn instagram-contact-btn" aria-label="Visiter mon profil Instagram">
